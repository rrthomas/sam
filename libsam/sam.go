...
var Instructions = map[string]Instruction{
	...
	"resume":  {C.SAM_INSTS_TAG, C.INST_RESUME, 0, true},
...
var Traps = map[string]uint{
	...
	"LIME":             C.TRAP_GRAPHICS_GREEN,
	"BLUE":             C.TRAP_GRAPHICS_BLUE,
	"CYAN":             C.TRAP_GRAPHICS_CYAN,
	"MAGENTA":          C.TRAP_GRAPHICS_MAGENTA,
	"FUSCHIA":          C.TRAP_GRAPHICS_MAGENTA,
	"YELLOW":           C.TRAP_GRAPHICS_YELLOW,
	"SILVER":           C.TRAP_GRAPHICS_SILVER,
	"GRAY":             C.TRAP_GRAPHICS_GRAY,
	"GREY":             C.TRAP_GRAPHICS_GRAY,
	"CHARCOAL":         C.TRAP_GRAPHICS_CHARCOAL,
	"SPRING_GREEN":     C.TRAP_GRAPHICS_SPRING_GREEN,
	"VIOLET":           C.TRAP_GRAPHICS_VIOLET,
	"SKY_BLUE":         C.TRAP_GRAPHICS_SKY_BLUE,
	"ORANGE":           C.TRAP_GRAPHICS_ORANGE,
	"BLUE_GREEN":       C.TRAP_GRAPHICS_BLUE_GREEN,
	"PINK":             C.TRAP_GRAPHICS_PINK,
	"FADED_BLUE":       C.TRAP_GRAPHICS_FADED_BLUE,
	"FADED_GREEN":      C.TRAP_GRAPHICS_FADED_GREEN,
	"FADED_CYAN":       C.TRAP_GRAPHICS_FADED_CYAN,
	"FADED_RED":        C.TRAP_GRAPHICS_FADED_RED,
	"BRICK_RED":        C.TRAP_GRAPHICS_FADED_RED,
	"FADED_PINK":       C.TRAP_GRAPHICS_FADED_PINK,
	"FADED_YELLOW":     C.TRAP_GRAPHICS_FADED_YELLOW,
	"DARK_RED":         C.TRAP_GRAPHICS_DARK_RED,
	"MAROON":           C.TRAP_GRAPHICS_DARK_RED,
	"DARK_GREEN":       C.TRAP_GRAPHICS_DARK_GREEN,
	"NAVY":             C.TRAP_GRAPHICS_NAVY,
	"PURPLE":           C.TRAP_GRAPHICS_PURPLE,
	"OLIVE":            C.TRAP_GRAPHICS_OLIVE,
	"TEAL":             C.TRAP_GRAPHICS_TEAL,
	"LIGHT_SKY_BLUE":   C.TRAP_GRAPHICS_LIGHT_SKY_BLUE,
	"BROWN":            C.TRAP_GRAPHICS_BROWN,
	"GOLD":             C.TRAP_GRAPHICS_GOLD,
	"BRONZE":           C.TRAP_GRAPHICS_BRONZE,
	"FAIR_SKIN":        C.TRAP_GRAPHICS_FAIR_SKIN,
	"WHITE_SKIN":       C.TRAP_GRAPHICS_FAIR_SKIN,
	"MEDIUM_SKIN":      C.TRAP_GRAPHICS_MEDIUM_SKIN,
	"OLIVE_SKIN":       C.TRAP_GRAPHICS_MEDIUM_SKIN,
	"LIGHT_BROWN_SKIN": C.TRAP_GRAPHICS_LIGHT_BROWN_SKIN,
	"BROWN_SKIN":       C.TRAP_GRAPHICS_BROWN_SKIN,
	"BLACK_SKIN":       C.TRAP_GRAPHICS_BLACK_SKIN,
	"DARK_BROWN_SKIN":  C.TRAP_GRAPHICS_BLACK_SKIN,
